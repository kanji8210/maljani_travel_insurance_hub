...
class Policy_CPT {
    ...
    /**
     * Register policy post meta fields in WPGraphQL so the headless Next.js
     * frontend can query them. Called on the graphql_register_types hook.
     */
    ...
    private function _do_register_graphql_fields() {
        ...
        register_graphql_field( 'Policy', 'policyInsurerLogo', [
            ...
            'resolve'     => function ( $post ) {
                ...
                if ( $logo_id ) return wp_get_attachment_url( $logo_id );
        ...
        register_graphql_field( 'Policy', 'policyCountries', [
            ...
            'resolve'     => function ( $post ) {
                ...
                foreach ( $terms as $region_name ) {
                    $result = array_merge( $result, $this->countries_for_region( $region_name ) );
                }
     ...
     */
    private function countries_for_region( string $region ): array {
